def arg_help(name):
  all_subargs = {
      ...
      "k3d": "k3d:ver,cluster-domain=K8S_CLUSTER_DOMAIN,ingress=PORT,ingress-type=[nginx|traefik|traefik-metallb|istio",
  ...
  examples = {
      ...
      "k3d": "anydbver deploy k3d:latest,cluster-domain=percona.local,ingress=443,ingress-type=nginx,nodes=3 cert-manager k8s-mongo:1.14.0,cluster-name=db1",
