...
def run_minio_server(args):
    ...
    run_helm(args.helm_path, ["helm", "repo", "add", "bitnami",
             "https://charts.bitnami.com/bitnami"], "helm repo add problem")
    ...
    if (args.cert_manager != "" and args.minio_certs == "self-signed") or args.minio_custom_ssl:
        helm_cmd = helm_cmd + ["--set", "tls.enabled=true", "--set",
                               "tls.autoGenerated.enabled=true", "--set", "service.ports.api=443"]
