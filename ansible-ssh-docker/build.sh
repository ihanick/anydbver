...
docker build --platform $PLATFORM -t centos:7-sshd-systemd .
cd ../rockylinux8
test -f ../../secret/id_rsa || ssh-keygen -t rsa -f ../../secret/id_rsa -P '' && chmod 0600 ../../secret/id_rsa
cp ../../tools/node_ip.sh ../../secret/id_rsa.pub ./
docker build --platform $PLATFORM -t rockylinux:8-sshd-systemd .
cd ../rockylinux9
test -f ../../secret/id_rsa || ssh-keygen -t rsa -f ../../secret/id_rsa -P '' && chmod 0600 ../../secret/id_rsa
cp ../../tools/node_ip.sh ../../secret/id_rsa.pub ./
docker build --platform $PLATFORM -t rockylinux:9-sshd-systemd .
cd ../jammy
test -f ../../secret/id_rsa || ssh-keygen -t rsa -f ../../secret/id_rsa -P '' && chmod 0600 ../../secret/id_rsa
cp ../../tools/node_ip.sh ../../secret/id_rsa.pub ./
docker build --platform $PLATFORM -t ubuntu:jammy-sshd-systemd .
cd ../..
